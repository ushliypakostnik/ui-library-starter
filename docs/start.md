...
Удалите все папки и файлы в <code class="nowrap">@/docs/</code> кроме директорий <code class="nowrap">@/docs/.vuepress</code>, <code class="nowrap">@/docs/components</code> и <code class="nowrap">@/docs/sandbox</code> - если желаете оставить Песочницу. И файла <code class="nowrap">@/docs/README.md</code>, который нужно оставить, но очистить:
