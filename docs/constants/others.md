...
Единственные глобальные стилевые классы которые при строгом подходе стоит использовать это анимации. Вы можете добавлять их в специальном файле стилевой базы <code>~/src/stylus/core/_animation.styl</code>: 
